create or replace view CardActivatedAbilityJoin as 

select concat(cwp.cardName, ' ', aa.activatedabilityid) as abilityKey, 
	cwp.*,
	aa.*,
...
right join wcard_activatedability wcaa on cwp.wcardid = wcaa.wcard_wcardid
join ActivatedAbilityJoin aa on aa.activatedabilityid = wcaa.activatedabilities_activatedabilityid