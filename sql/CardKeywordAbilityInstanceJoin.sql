create or replace view CardkeywordAbilityInstanceJoin as 

select concat(cwp.cardName, ' ', aa.keywordAbilityInstanceid) as abilityKey, 
	cwp.*,
	aa.*,
...
right join wcard_keywordAbilityInstance wcaa on cwp.wcardid = wcaa.wcard_wcardid
join keywordAbilityInstanceJoin aa on aa.keywordAbilityInstanceid = wcaa.keywordabilities_keywordAbilityInstanceid